        ...
        <div class="bg-gray-50 py-20">
            <div class="xl:container mx-auto px-3 sm:px-4 xl:px-2">
                <div class="flex flex-row flex-wrap">
                            ...
                            <div class="max-w-full w-full px-4">
                                ...
                                <div class="leading-relaxed pb-4">
                                   ...
                                   <div v-html="post.body" class="mb-2"></div>
                                    ...
                                    <p class="mb-5">
                                        Integer egestas ipsum eget metus sodales consectetur. Nullam ultricies posuere cursus.
                                        Duis vitae lorem porta, venenatis nibh ac, laoreet massa. Nam risus lacus, porta eu diam id, fringilla porta risus.
                                        Aenean sit amet malesuada diam.
                                    </p>
                                    <figure class="text-center mb-6">
                                        <img class="max-w-full h-auto" src="@/img/dummy/post1.jpg" alt="Image description" />
                                        <figcaption>Type here your description</figcaption>
                                    </figure>
                                    ...
                                    <p class="mb-5">
                                        ...
                                        Mauris malesuada ligula in interdum pharetra. Interdum et malesuada fames ac ante ipsum primis in faucibus.
                                    </p>
                                    <p class="mb-5">
                                        Integer egestas ipsum eget metus sodales consectetur. Nullam ultricies posuere cursus.
                                        Duis vitae lorem porta, venenatis nibh ac, laoreet massa. Nam risus lacus, porta eu diam id, fringilla porta risus.
                                    ...
                                    <blockquote class="relative p-4 border-l-4 border-red-700 bg-gray-100 dark:bg-gray-900 dark:bg-opacity-40 mb-4 text-xl">
                                        <span class="absolute opacity-80 w-8 h-8">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="text-red-700" viewBox="0 0 270 270">
                                                <g transform="translate(0,270) scale(0.1,-0.1)" fill="currentColor" stroke="none">
                                    ...
                                    <div class="relative flex flex-row items-center justify-between overflow-hidden bg-gray-100 dark:bg-gray-900 dark:bg-opacity-20 mt-12 mb-2 px-6 py-2">
                                        <div class="my-4 text-sm">
                                            ...
                                            <span class="mr-2 md:mr-4">
                                                ...
                                                by <a class="font-semibold" href="#">Ari Budin</a>
                                            </span>
                                            <!--date-->
                    ...
                    <!-- right -->
                    <div class="flex-shrink max-w-full w-full lg:w-1/3 lg:pl-8 lg:pt-14 lg:pb-8 lg:order-last">
                            ...
                            <div class="mb-6">
                                ...
                                <ul class="post-number">
                                    <li class="border-b border-gray-100 hover:bg-gray-50">
                                        <a class="text-lg font-bold px-6 py-3 flex flex-row items-center" href="#">
                        ...
                        <div class="text-sm py-6 sticky">
                            <div class="w-full text-center">
                                ...
                                <a href="#">
                                    <img class="mx-auto" src="@/img/ads/250.jpg" alt="advertisement area" />
                                </a>
                            </div>
                        </div>
                    </div>
