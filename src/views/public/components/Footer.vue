<template>
  ...
  <footer class="bg-black text-gray-400">
    ...
    <div id="footer-content" class="relative pt-8 xl:pt-16 pb-6 xl:pb-12">
      <div class="max-w-screen-xl container mx-auto px-3 sm:px-4 xl:px-2 overflow-hidden">
    ...
    <div class="footer-dark">
      <div class="w-full py-4 border-t border-gray-800">
        <div class="row">
  ...
  <!-- =========={ SCROLL TO TOP }==========  -->
  <a href="#" class="back-top fixed p-4 rounded bg-red-500 border border-gray-100 text-gray-500 dark:bg-gray-900 dark:border-gray-800 right-4 bottom-4 hidden" aria-label="Scroll To Top">
