<template>
  <nav class="bg-white dark:bg-gray-900 fixed w-full z-20 top-0 start-0 border-b border-gray-200 dark:border-gray-600">
    <div class="max-w-screen-xl container flex flex-wrap items-center gap-x-5 mx-auto p-4">
      <!-- Logo -->
      ...
      <!-- Hamburger Button -->
      <button @click="toggleMenu" class="md:hidden text-gray-500 hover:text-black items-end-safe dark:text-white focus:outline-none">
